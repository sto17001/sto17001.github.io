const apiURL = "https://api.openweathermap.org/data/2.5/weather?id=5607916&appid=bb98ec60049766ba796288b29310adc3&units=imperial";
fetch(apiURL)
...
const apiURLforecast = "https://api.openweathermap.org/data/2.5/forecast?id=5607916&appid=bb98ec60049766ba796288b29310adc3&units=imperial";
...
fetch(requestURL)
    ...
    .then(function (jsonObject) {
        ...
        const sodaSpringsfilter = towns.filter(x => x.name == 'Soda Springs');
        let sodaSpringsEvents = sodaSpringsfilter[0].events;
        let ul = document.createElement('ul');

        sodaSpringsEvents.forEach(info => {
            let listItem = document.createElement('li');
            listItem.innerHTML = info;
            ul.appendChild(listItem);
        });

        document.getElementById("sodaSpringsEvents").appendChild(ul);
    });